...
function App() {
  ...
  return (
    <div className="bg-gradient-to-b from-[#fff4e6] to-[#f0e6ff] min-h-screen text-gray-800 font-sans overflow-x-hidden">
      ...
      {/* Enhanced Navbar */}
      <header className="bg-white/95 backdrop-blur-md shadow-xl sticky top-0 z-50 border-b border-purple-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center py-4">
          <div className="flex items-center space-x-3 animate-fadeInLeft">
            ...
            <div>
              <h1 className="text-2xl font-bold bg-gradient-to-r from-[#ED9C49] to-[#8B5CF6] bg-clip-text text-transparent">
                NumeroMantra
              </h1>
              <p className="text-xs text-purple-600">Decode Your Destiny</p>
            </div>
          </div>
          
          <nav className="hidden md:flex space-x-8 text-[#458A95] font-semibold">
            {[
              { name: 'Home' },
              { name: 'About' },
              { name: 'Services' },
              ...
              <a
                ...
                className="hover:text-[#ED9C49] transition-all duration-300 hover:scale-110 transform relative group py-2"
          ...
          <a
            href="tel:6359551151"
            className="bg-gradient-to-r from-[#ED9C49] via-[#8B5CF6] to-[#EC4899] text-white px-6 py-3 rounded-full hover:shadow-2xl transform hover:scale-105 transition-all duration-300 animate-shimmer"
          >
      ...
      <section
        id="home"
        className="relative bg-cover bg-center py-40 text-center text-white px-4 overflow-hidden"
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          <div className="animate-fadeInUp">
            ...
            <p className="text-xl sm:text-2xl max-w-4xl mx-auto mb-12 opacity-95 leading-relaxed" style={{ animationDelay: '0.3s' }}>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
              <a
                ...
                className="group bg-gradient-to-r from-[#ED9C49] to-[#d7862f] text-white px-10 py-5 rounded-full hover:shadow-2xl transform hover:scale-110 transition-all duration-500 font-bold text-lg"
              >
              ...
              <a
                href="tel:6359551151"
                className="group bg-white/20 backdrop-blur-md text-white px-8 py-4 rounded-full hover:bg-white/30 transition-all duration-300 font-semibold border border-white/30"
              >
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4">
          <h3 className="text-4xl font-bold text-center mb-16 bg-gradient-to-r from-[#458A95] to-[#ED9C49] bg-clip-text text-transparent">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-9 gap-4">
            {numerologyFacts.map((fact, index) => (
              <div 
                ...
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <div className={`text-4xl font-bold ${fact.color} mb-2 group-hover:scale-125 transition-transform`}>
                  {fact.number}
                </div>
                <p className="text-xs text-gray-600 leading-tight">{fact.meaning}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section 
        id="about" 
        className="px-4 sm:px-8 py-24 bg-gradient-to-r from-purple-50 to-pink-50 relative"
        data-animate
      >
        <div className={`max-w-6xl mx-auto transition-all duration-1000 ${isVisible.about ? 'animate-fadeInUp' : 'opacity-0 translate-y-10'}`}>
          <div className="text-center mb-16">
            <h3 className="text-4xl sm:text-5xl font-bold text-[#458A95] mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {[
              ...
              >
                <div className="text-3xl font-bold text-[#ED9C49] mb-2 counter-animate">
                  {stat.number}
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="feature-card group">
                <div className={`w-16 h-16 rounded-full bg-gradient-to-r ${feature.color} flex items-center justify-center text-2xl mb-4 mx-auto group-hover:scale-110 transition-transform font-bold text-white`}>
                  {index + 1}
                </div>
                <h4 className="text-xl font-bold text-[#ED9C49] mb-3">{feature.title}</h4>
      ...
      <section id="services" className="px-4 sm:px-8 py-24 bg-gradient-to-b from-white to-purple-50 relative" data-animate>
        <div className={`transition-all duration-1000 ${isVisible.services ? 'animate-fadeInUp' : 'opacity-0 translate-y-10'}`}>
          <div className="text-center mb-20">
            <h3 className="text-4xl sm:text-5xl font-bold text-[#ED9C49] mb-6">
            ...
            {[{
              ...
              >
                <div className="relative overflow-hidden rounded-t-xl">
                  ...
                  />
                  <div className="absolute top-4 left-4 bg-[#ED9C49] text-white px-3 py-1 rounded-full font-bold">
                    {service.price}
                  </div>
                ...
                <div className="p-6">
                  <h4 className="text-xl font-bold text-[#ED9C49] mb-3 group-hover:text-[#458A95] transition-colors">
                    {service.title}
                  </h4>
                  ...
                  <button className="w-full bg-gradient-to-r from-[#ED9C49] to-[#d7862f] text-white py-3 rounded-full hover:shadow-lg transform hover:scale-105 transition-all duration-300 font-semibold">
                    Book Now
                  </button>
                </div>
              </div>
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-pink-600 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 text-center">
          <h3 className="text-4xl font-bold mb-16">Life-Changing Experiences</h3>
      ...
      <section id="blog" className="px-4 sm:px-8 py-24 bg-white" data-animate>
        <div className={`transition-all duration-1000 ${isVisible.blog ? 'animate-fadeInUp' : 'opacity-0 translate-y-10'}`}>
          <div className="text-center mb-20">
            <h3 className="text-4xl sm:text-5xl font-bold text-[#458A95] mb-6">
          ...
          <div className="grid gap-12 sm:grid-cols-2 max-w-6xl mx-auto">
            {[{
              ...
              <div 
                key={blog.title} 
                className="blog-card-enhanced group cursor-pointer"
                style={{ animationDelay: `${index * 0.2}s` }}
              >
                <div className="relative overflow-hidden rounded-t-xl">
                  <img 
                  ...
                  />
                  <div className="absolute top-4 left-4 bg-[#ED9C49] text-white px-4 py-2 rounded-full text-sm font-bold">
                    {blog.category}
                  </div>
                ...
                <div className="p-8">
                  ...
                  <h4 className="text-2xl font-bold text-[#ED9C49] mb-4 group-hover:text-[#458A95] transition-colors leading-tight">
                    {blog.title}
                  </h4>
                  
                  <p className="text-gray-700 leading-relaxed mb-6 text-lg">{blog.excerpt}</p>
          ...
          <div className="text-center mt-12">
            <a href="#blog" className="bg-gradient-to-r from-[#458A95] to-[#ED9C49] text-white px-8 py-4 rounded-full hover:shadow-xl transform hover:scale-105 transition-all duration-300 font-semibold">
      ...
      <section id="contact" className="px-4 sm:px-8 py-24 bg-gradient-to-br from-purple-900 via-pink-900 to-indigo-900 text-white relative overflow-hidden" data-animate>
        ...
        <div className={`relative z-10 max-w-6xl mx-auto text-center transition-all duration-1000 ${isVisible.contact ? 'animate-fadeInUp' : 'opacity-0 translate-y-10'}`}>
          ...
          <p className="text-2xl mb-12 max-w-4xl mx-auto leading-relaxed opacity-95">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {[
              ...
              <a 
                ...
                className="contact-card-enhanced group"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <div className={`w-16 h-16 rounded-full bg-gradient-to-r ${contact.color} flex items-center justify-center text-3xl mb-4 mx-auto group-hover:scale-125 transition-transform duration-300 font-bold text-white`}>
                  {index + 1}
                </div>
                <h4 className="text-xl font-bold mb-2">{contact.title}</h4>
                <p className="text-purple-200 mb-3 text-sm">{contact.desc}</p>
                <div className="font-semibold text-yellow-300 group-hover:text-white transition-colors">
                  {contact.value}
                </div>
              </a>
            ))}
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 max-w-2xl mx-auto border border-white/20">
            <h4 className="text-2xl font-bold mb-4 text-yellow-300">Limited Time Offer</h4>
            <p className="text-lg mb-6">Get your first numerology reading absolutely FREE! Discover your Life Path number and unlock your destiny.</p>
            <a 
              href="mailto:numeromantra1355@gmail.com?subject=Free Numerology Reading"
              className="bg-gradient-to-r from-yellow-400 to-orange-500 text-black px-8 py-4 rounded-full hover:shadow-2xl transform hover:scale-105 transition-all duration-300 font-bold inline-block"
            >
      ...
      <footer className="bg-gradient-to-b from-gray-900 to-black text-white py-20 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12">
          <div className="animate-fadeInLeft">
            <div className="flex items-center space-x-3 mb-6">
              <img src={logo} alt="NumeroMantra Logo" className="h-16 hover:scale-105 transition-transform" />
              <div>
                <h4 className="text-2xl font-bold bg-gradient-to-r from-[#ED9C49] to-[#FFD700] bg-clip-text text-transparent">
                  NumeroMantra
                </h4>
              ...
              {['Home', 'About', 'Services', 'Blog', 'Contact'].map((item) => (
                <li key={item}>
                  <a 
                    ...
                    className="text-gray-300 hover:text-[#ED9C49] transition-colors hover:translate-x-2 transform inline-flex items-center space-x-2 group"
                  >
          ...
          <div className="animate-fadeInRight">
            ...
            <a 
              ...
              className="whatsapp-float-footer group"
            >
              <img
                src="https://img.icons8.com/color/48/000000/whatsapp--v1.png"
                alt="WhatsApp"
                className="h-12 w-12 group-hover:scale-125 transition-transform"
              />
        ...
        <div className="border-t border-gray-700 mt-16 pt-8 text-center relative">
