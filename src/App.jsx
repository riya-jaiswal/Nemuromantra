        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8  ">
          <div className="flex justify-between items-center py-3 sm:py-4">
            ...
            <div className="flex items-center space-x-3 ">
              <a
                href="tel:6359551151"
                className="hidden sm:flex bg-gradient-to-r from-[#ED9C49] via-[#8B5CF6] to-[#EC4899] text-white px-3 sm:px-6 py-2 sm:py-3 rounded-full hover:shadow-2xl transform hover:scale-105 transition-all duration-300 animate-shimmer text-sm sm:text-base font-semibold"
              >
            ...
            <nav className="py-4 border-t border-purple-200">
              ...
              <div className="px-4 pt-4  ">
                <a
                  href="tel:6359551151"
                  onClick={handleMobileMenuClick}
                  className="block w-full bg-gradient-to-r from-[#ED9C49] via-[#8B5CF6] to-[#EC4899] text-white py-3 rounded-full hover:shadow-2xl transform hover:scale-105 transition-all duration-300 animate-shimmer text-center font-semibold"
                >
                  Get Reading Now
                </a>
              </div>
            ...
            <div className="animate-fadeInUp">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center mb-8 sm:mb-12 px-2">
                <a
                  ...
                  className="group bg-gradient-to-r from-[#ED9C49] to-[#d7862f] text-white px-6 sm:px-10 py-3 sm:py-5 rounded-full hover:shadow-2xl transform hover:scale-110 transition-all duration-500 font-bold text-base sm:text-lg w-full sm:w-auto text-center"
                >
        ...
        <section id="blog" className="px-4 sm:px-8 py-16 sm:py-20 lg:py-24 bg-white" data-animate>
          <div className={`transition-all duration-1000 ${isVisible.blog ? 'animate-fadeInUp' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="text-center mt-12">
              <a href="#blog" className="bg-gradient-to-r from-[#458A95] to-[#ED9C49] text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full hover:shadow-xl transform hover:scale-105 transition-all duration-300 font-semibold">
          ...
          <div className={`relative z-10 max-w-6xl mx-auto text-center transition-all duration-1000 ${isVisible.contact ? 'animate-fadeInUp' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 sm:p-8 max-w-2xl mx-auto border border-white/20">
              ...
              <a 
                ...
                className="bg-gradient-to-r from-yellow-400 to-orange-500 text-black px-6 sm:px-8 py-3 sm:py-4 rounded-full hover:shadow-2xl transform hover:scale-105 transition-all duration-300 font-bold inline-block text-sm sm:text-base"
              >
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
                ...
                {['Home', 'About', 'Services', 'Blog', 'Contact'].map((item) => (
                  <li key={item}>
                    <a 
                      ...
                      className="text-gray-300 hover:text-[#ED9C49] transition-colors hover:translate-x-2 transform inline-flex items-center space-x-2 group text-sm sm:text-base"
                    >
            ...
            <div className="animate-fadeInRight">
              ...
              <a 
                ...
                className="whatsapp-float-footer group flex items-center space-x-3 w-fit  bg-green-600 hover:bg-green-500 px-4 py-1 rounded-full transition-all duration-300"
              >
                <img
                  src="https://img.icons8.com/color/48/000000/whatsapp--v1.png"
                  alt="WhatsApp"
                  className="h-8 w-8 sm:h-12 sm:w-12 group-hover:scale-125 transition-transform"
                />
